...
import com.codewithabdul.blog.configure.AppConstants;
...
import com.codewithabdul.blog.services.FileService;
...
public class PostController 
{
  ...
  (@RequestBody PostDto postDto,@PathVariable Integer userId, @PathVariable Integer categoryId)
  {
    ...
    public ApiResponse deletePost(@PathVariable Integer postId)
    {
    	...
    	return new ApiResponse("postis succesfully deleted",true);
    }
